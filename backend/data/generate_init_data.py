...
(1, 'user001', '{password_hash}', 'user001@shop.com', '13800138001', '张三', 'https://picsum.photos/id/1005/100/100', 1, '1990-01-01', 1, 0, 0, '2024-01-01 00:00:00', '张', '三'),
(2, 'user002', '{password_hash}', 'user002@shop.com', '13800138002', '李四', 'https://picsum.photos/id/1012/100/100', 0, '1995-05-15', 1, 0, 0, '2024-02-01 00:00:00', '李', '四'),
(3, 'user003', '{password_hash}', 'user003@shop.com', '13800138003', '王五', 'https://picsum.photos/id/1025/100/100', 1, '1998-08-20', 1, 0, 0, '2024-02-15 00:00:00', '王', '五'),
(4, 'user004', '{password_hash}', 'user004@shop.com', '13800138004', '赵六', 'https://picsum.photos/id/1074/100/100', 0, '2000-11-30', 1, 0, 0, '2024-03-01 00:00:00', '赵', '六'),
(5, 'user005', '{password_hash}', 'user005@shop.com', '13800138005', '孙七', 'https://picsum.photos/id/1066/100/100', 1, '1993-04-10', 1, 0, 0, '2024-03-15 00:00:00', '孙', '七'),
(6, 'user006', '{password_hash}', 'user006@shop.com', '13800138006', '周八', 'https://picsum.photos/id/1084/100/100', 0, '1997-07-25', 1, 0, 0, '2024-04-01 00:00:00', '周', '八'),
(7, 'user007', '{password_hash}', 'user007@shop.com', '13800138007', '吴九', 'https://picsum.photos/id/1033/100/100', 1, '1999-09-05', 1, 0, 0, '2024-04-15 00:00:00', '吴', '九'),
(8, 'user008', '{password_hash}', 'user008@shop.com', '13800138008', '郑十', 'https://picsum.photos/id/1043/100/100', 0, '1992-12-18', 1, 0, 0, '2024-05-01 00:00:00', '郑', '十'),
(9, 'user009', '{password_hash}', 'user009@shop.com', '13800138009', '冯十一', 'https://picsum.photos/id/1057/100/100', 1, '1996-03-22', 1, 0, 0, '2024-05-15 00:00:00', '冯', '十一'),
(10, 'user010', '{password_hash}', 'user010@shop.com', '13800138010', '陈十二', 'https://picsum.photos/id/1062/100/100', 0, '2001-06-08', 1, 0, 0, '2024-06-01 00:00:00', '陈', '十二');
...
(1, 'admin', '{password_hash}', 'admin@shop.com', '13800138000', 'https://picsum.photos/id/1/100/100', 1, 1, '2024-06-01 10:00:00', '2024-01-01 00:00:00', '2024-06-01 10:00:00'),
(2, 'manager', '{password_hash}', 'manager@shop.com', '13800138011', 'https://picsum.photos/id/2/100/100', 2, 1, '2024-06-01 09:00:00', '2024-01-15 00:00:00', '2024-06-01 09:00:00'),
(3, 'operator1', '{password_hash}', 'operator1@shop.com', '13800138012', 'https://picsum.photos/id/3/100/100', 3, 1, NULL, '2024-02-01 00:00:00', '2024-02-01 00:00:00'),
(4, 'operator2', '{password_hash}', 'operator2@shop.com', '13800138013', 'https://picsum.photos/id/4/100/100', 3, 1, NULL, '2024-02-15 00:00:00', '2024-02-15 00:00:00'),
(5, 'operator3', '{password_hash}', 'operator3@shop.com', '13800138014', 'https://picsum.photos/id/5/100/100', 3, 1, NULL, '2024-03-01 00:00:00', '2024-03-01 00:00:00'),
(6, 'admin2', '{password_hash}', 'admin2@shop.com', '13800138015', 'https://picsum.photos/id/6/100/100', 2, 1, '2024-05-30 14:00:00', '2024-03-15 00:00:00', '2024-05-30 14:00:00'),
(7, 'operator4', '{password_hash}', 'operator4@shop.com', '13800138016', 'https://picsum.photos/id/7/100/100', 3, 1, NULL, '2024-04-01 00:00:00', '2024-04-01 00:00:00'),
(8, 'operator5', '{password_hash}', 'operator5@shop.com', '13800138017', 'https://picsum.photos/id/8/100/100', 3, 1, NULL, '2024-04-15 00:00:00', '2024-04-15 00:00:00'),
(9, 'admin3', '{password_hash}', 'admin3@shop.com', '13800138018', 'https://picsum.photos/id/9/100/100', 2, 1, NULL, '2024-05-01 00:00:00', '2024-05-01 00:00:00'),
(10, 'operator6', '{password_hash}', 'operator6@shop.com', '13800138019', 'https://picsum.photos/id/10/100/100', 3, 0, NULL, '2024-05-15 00:00:00', '2024-05-15 00:00:00');
...
output_path = os.path.join(os.path.dirname(__file__), 'init_data.sql')
with open(output_path, 'w', encoding='utf-8') as f:
    f.write(sql_content)

print(f'init_data.sql generated successfully at: {output_path}')